...
do $$
declare
  v_solicitante uuid := '10000000-0000-4000-8000-000000000001';
  v_revisor     uuid := '10000000-0000-4000-8000-000000000002';
  v_aprobador   uuid := '10000000-0000-4000-8000-000000000003';
  v_contab      uuid := '10000000-0000-4000-8000-000000000004';
  v_obra1 uuid := '30000000-0000-4000-8000-000000000001';
  v_obra2 uuid := '30000000-0000-4000-8000-000000000002';
  v_obra3 uuid := '30000000-0000-4000-8000-000000000003';
  v_soc1 uuid := '20000000-0000-4000-8000-000000000001';
  v_soc2 uuid := '20000000-0000-4000-8000-000000000002';
  v_soc3 uuid := '20000000-0000-4000-8000-000000000003';
  v_prov1 uuid := '40000000-0000-4000-8000-000000000001';
  v_prov2 uuid := '40000000-0000-4000-8000-000000000002';
  v_prov3 uuid := '40000000-0000-4000-8000-000000000003';
