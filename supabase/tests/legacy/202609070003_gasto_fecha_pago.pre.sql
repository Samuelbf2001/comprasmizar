...
insert into public.sociedades (id, nombre) values
  ('90000000-0000-0000-0000-000000000001', 'Legado FP Sociedad')
  on conflict (id) do nothing;

insert into public.obras (id, nombre, sociedad_id, estado) values
  ('90000000-0000-0000-0000-000000000002', 'Legado FP Obra', '90000000-0000-0000-0000-000000000001', 'activa')
  on conflict (id) do nothing;

insert into auth.users (id, email) values
  ('90000000-0000-0000-0000-000000000003', 'legado-fp-solicitante@mizar.test')
  on conflict (id) do nothing;
insert into public.usuarios (id, nombre, email, estado) values
  ('90000000-0000-0000-0000-000000000003', 'Legado FP Solicitante', 'legado-fp-solicitante@mizar.test', 'activo')
  on conflict (id) do nothing;

insert into public.proveedores (id, razon_social) values
  ('90000000-0000-0000-0000-000000000004', 'Legado FP Proveedor')
  on conflict (id) do nothing;
...
insert into public.requisiciones (id, consecutivo, tipo, obra_id, solicitante_id, canal) values
  ('90000000-0000-0000-0000-000000000005', '', 'compra', '90000000-0000-0000-0000-000000000002', '90000000-0000-0000-0000-000000000003', 'web')
  on conflict (id) do nothing;
insert into public.ordenes (id, consecutivo, tipo, requisicion_id, proveedor_id, estado_administrativo, contabilizada_at, pagada_at) values
  ('90000000-0000-0000-0000-000000000006', 'OC-LEGADO-FP-0001', 'OC', '90000000-0000-0000-0000-000000000005', '90000000-0000-0000-0000-000000000004', 'pagada', '2026-08-31T12:00:00Z', '2026-09-01T03:30:00Z')
  on conflict (id) do nothing;
insert into public.gastos (id, obra_id, origen, referencia_id, proveedor_id, fecha, valor_base, iva) values
  ('90000000-0000-0000-0000-000000000007', '90000000-0000-0000-0000-000000000002', 'requisicion', '90000000-0000-0000-0000-000000000006', '90000000-0000-0000-0000-000000000004', '2026-08-10', 300000, 57000)
  on conflict (id) do nothing;
...
insert into public.requisiciones (id, consecutivo, tipo, obra_id, solicitante_id, canal) values
  ('90000000-0000-0000-0000-000000000008', '', 'compra', '90000000-0000-0000-0000-000000000002', '90000000-0000-0000-0000-000000000003', 'web')
  on conflict (id) do nothing;
insert into public.ordenes (id, consecutivo, tipo, requisicion_id, proveedor_id, estado_administrativo) values
  ('90000000-0000-0000-0000-000000000009', 'OC-LEGADO-FP-0002', 'OC', '90000000-0000-0000-0000-000000000008', '90000000-0000-0000-0000-000000000004', 'pendiente')
  on conflict (id) do nothing;
insert into public.gastos (id, obra_id, origen, referencia_id, proveedor_id, fecha, valor_base, iva) values
  ('90000000-0000-0000-0000-00000000000a', '90000000-0000-0000-0000-000000000002', 'requisicion', '90000000-0000-0000-0000-000000000009', '90000000-0000-0000-0000-000000000004', '2026-08-20', 100000, 19000)
  on conflict (id) do nothing;
...
insert into public.caja_menor (id, obra_id, fecha, concepto, valor, registrado_por) values
  ('90000000-0000-0000-0000-00000000000b', '90000000-0000-0000-0000-000000000002', '2026-08-25', 'Legado FP caja menor', 45000, '90000000-0000-0000-0000-000000000003')
  on conflict (id) do nothing;
