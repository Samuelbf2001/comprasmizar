...
const event = { eventId: "evt-1", type: "flow_submission" as const, receivedAt: "2026-08-24T00:00:00.000Z", submission: { eventId: "evt-1", phone: "+573001234567", societyId: "soc", workId: "work", requiredDate: "2026-08-30", type: "compra" as const, requesterName: "Maestro", items: [] } };
...
describe("Adaptador de WhatsApp Flow (nfm_reply) + coordinador de idempotencia", () => {
  ...
  function rawNfmReply(wamid: string): RawKapsoWebhookPayload {
    const responseJson = JSON.stringify({
      ...
      type: "compra", societyId: "22222222-2222-4222-8222-222222222222", requiredDate: "2026-08-30", requesterName: "Maestro Flow",
  ...
  it("traduce y crea exactamente una vez; el reintento del mismo wamid da 'duplicate'", async () => {
    const durable = store();
    let creates = 0;
    const creator = { findExisting: async () => null, create: async () => { creates++; return { id: "req-flow", consecutive: "REQ", type: "compra" as const, societyId: "soc", workId: "22222222-2222-4222-8222-222222222222", channel: "whatsapp" as const, requiredDate: "2026-08-30", status: "enviada" as const, items: [] }; } };
  ...
  it("un wamid distinto sí crea una segunda requisición", async () => {
    ...
    let creates = 0;
    const creator = { findExisting: async () => null, create: async () => { creates++; return { id: `req-flow-${creates}`, consecutive: "REQ", type: "compra" as const, societyId: "soc", workId: "22222222-2222-4222-8222-222222222222", channel: "whatsapp" as const, requiredDate: "2026-08-30", status: "enviada" as const, items: [] }; } };
