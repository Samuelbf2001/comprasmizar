...
export function createMcpServer(actor: Actor, services: McpServices): McpServer {
  ...
  // crear (CatalogService.create decide por el permiso "catalog:manage" — admin_sixteam, revisor, o
  // admin_mizar con el autoservicio activo). Ninguna herramienta toca usuarios ni aprueba: `mcpForbidden`
  // (lib/domain/rules.ts) sigue bloqueando aprobar/devolver/revisar aunque el revisor administre todo.
