      ...
      <SectionTitle
        ...
        action={
          <div className="title-actions">
            ...
            {canWrite && <button className="button button-dark" type="button" onClick={openCreate}><Plus size={15} /> Nuevo proveedor</button>}
          </div>
        }
      />
      ...
      <section className="panel supplier-list-panel">
        <div className="panel-head supplier-toolbar">
          ...
          <div className="supplier-filters">
            <label className="supplier-search"><Search size={15} /><span className="sr-only">Buscar proveedores</span><input value={query} onChange={(event) => setQuery(event.target.value)} placeholder="Buscar por nombre, NIT o contacto" /></label>
